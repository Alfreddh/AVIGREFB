<x-sitelayout>
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.site activePage='Home'></x-navbars.navs.site>
            <!-- End Navbar -->
            <section class="hero-wrap js-fullheight">
		<div class="home-slider js-fullheight owl-carousel">
			<div class="slider-item js-fullheight" style="background-image:url('{{ asset('assets/site/images/bg_1.jpg') }}');">
						...
						<div class="col-md-10 col-lg-7 ftco-animate">
							<div class="text w-100">
								...
								<div class="d-flex meta">
									<div class=""><p class="mb-0"><a href="#" class="btn btn-secondary py-3 px-2 px-md-4">Devenir un volontaire</a></p></div>
			...
			<div class="slider-item js-fullheight" style="background-image:url('{{ asset('assets/site/images/bg_2.jpg') }}');">
				<div class="overlay-1"></div><div class="overlay-2"></div><div class="overlay-3"></div><div class="overlay-4"></div>
				<div class="container">
					<div class="row no-gutters slider-text js-fullheight align-items-center">
						<div class="col-md-10 col-lg-7 ftco-animate">
			...
			<div class="slider-item js-fullheight" style="background-image:url('{{ asset('assets/site/images/bg_3.jpg') }}');">
				<div class="overlay-1"></div><div class="overlay-2"></div><div class="overlay-3"></div><div class="overlay-4"></div>
				<div class="container">
					<div class="row no-gutters slider-text js-fullheight align-items-center">
						<div class="col-md-10 col-lg-7 ftco-animate">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 wrap-about py-5">
					...
					<p><a href="#" class="btn btn-secondary btn-outline-secondary">Devenir un volontaire</a></p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row no-gutters">
				<div class="col-md-3 d-flex align-items-stretch">
					<div class="services">
						...
						<div class="img border-2" style="background-image: url('{{ asset('assets/site/images/services-1.jpg') }}');">
							<div class="icon d-flex align-items-center justify-content-center">
								<span class="flaticon-volunteer"></span>
							</div>
						</div>
				...
				<div class="col-md-3 d-flex align-items-stretch">
					<div class="services">
						...
						<div class="img border-3" style="background-image: url('{{ asset('assets/site/images/services-2.jpg') }}');">
							<div class="icon d-flex align-items-center justify-content-center">
								<span class="flaticon-piggy-bank"></span>
							</div>
						</div>
				...
				<div class="col-md-3 d-flex align-items-stretch">
					<div class="services">
						...
						<div class="img border-1" style="background-image: url('{{ asset('assets/site/images/services-3.jpg') }}');">
							<div class="icon d-flex align-items-center justify-content-center">
				...
				<div class="col-md-3 d-flex align-items-stretch">
					<div class="services">
						...
						<div class="img border-4" style="background-image: url('{{ asset('assets/site/images/services-4.jpg') }}');">
							<div class="icon d-flex align-items-center justify-content-center">
			...
			<div class="row">
				<div class="col-md-6 col-lg-3">
					<div class="causes causes-2 text-center ftco-animate">
						<a href="#" class="img w-100" style="background-image: url('{{ asset('assets/site/images/causes-1.jpg') }}');"></a>
						<div class="text p-3">
		...
		<div class="container">
			<div class="row justify-content-between">
				...
				<div class="col-md-4 col-lg-4 d-flex align-items-center justify-content-end">
					<p class="mb-0"><a href="#" class="btn btn-primary py-3 px-4">Devenir un volontaire</a></p>
				</div>
			</div>
		</div>
	</section>
