...
<aside
    ...
    <div class="">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">VR AVIGREF</span>
        </a>
    </div>
    ...
    <div class="" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Gestions</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'rapports' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('rapports') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Autres pages</h6>
            </li>
            <li class="nav-item">
