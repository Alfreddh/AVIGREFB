                                    ...
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                        ...
                                        <div class="row mt-3">
                                            <h6 class='text-white text-center'>
                                                <span class="font-weight-normal"> Veuillez entrer vos identifiants <br> pour accéder à votre espace personnel.</span> 
                                            </h6>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}" class="text-start">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ old('email', 'default@example.com') }}">
                                        </div>
                                        @error('email')
